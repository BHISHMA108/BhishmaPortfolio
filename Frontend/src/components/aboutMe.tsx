    ...
    >
      <div className="w-full flex">
        <motion.div
          ...
          className=" h-full lg:min-h-[450px]  bg-[url('/.jpg')] bg-cover bg-center p-7 border border-lb-4 rounded-4xl w-full"
        >
          ...
          <p className="hidden md:block text-[18px] md:text-2xl lg:text-3xl font-normal tracking-wider text-justify ">
            I’m Uday Dandekar, a frontend developer and engineering student at
            VIT Pune. I specialize in Docker, React.js, and Tailwind CSS, with a
            growing interest in AI and 3D web technologies. I’ve worked as a
            Frontend Intern at Herbs Magic, served as a Google Student
            Ambassador, and contributed to projects like Gyansetu and
            EfficienSee.
          </p>
          <p className="block md:hidden text-2xl  lg:text-3xl tracking-wider   ">
            ...
            Magic, served as a Google Student Ambassador, and built projects
