...
function Skills() {
  return (
    <div
      id="skills"
      className="min-h-screen font-google relative bg-[url('/skillbg.png')] bg-cover"
    >
      <h1 className=" relative z-10 px-9 lg:px-28 text-5xl lg:text-6xl font-medium">
        Skills
      </h1>

      <div className="skillsdivbg absolute -z-50 transform scale-350 translate-y-[600px] translate-x-[1100px] h-[700px] w-[700px] blur bg-[url('/skillsbg.png')] bg-cover bg-center"></div>
    ...
    focus:shadow-xl focus:shadow-purple-700/70 transition-all duration-300 ease-in-out"
        ...
        <div
          onTouchStart={(e) => e.currentTarget.classList.add("!scale-[1.03]")}
          onTouchEnd={(e) => e.currentTarget.classList.remove("!scale-[1.03]")}
          className="col-span-1 p-2 rounded-3xl bg-white/5 backdrop-blur-md
    transition duration-500 hover:bg-gradient-to-r 
    hover:from-purple-500 hover:via-blue-900/40 hover:to-blue-700
    active:bg-gradient-to-r active:from-purple-500/40 active:via-blue-500 active:to-blue-700
    focus:bg-gradient-to-r focus:from-purple-500 focus:via-blue-900 focus:to-blue-700
    hover:shadow-xl hover:shadow-purple-700/70
    active:shadow-xl active:shadow-purple-700/70
    focus:shadow-xl focus:shadow-purple-700/70 transition-all duration-300 ease-in-out"
        >
          <img
            src="https://cdn.dribbble.com/users/3490038/screenshots/13820034/media/b97df08e400f38b1e4bc08b8475d78f9.png"
            className="w-full h-[81px] md:h-[120px] object-contain bg-black rounded-2xl"
            loading="lazy"
            alt=""
          />
